...
/**
 * A collection of utility methods to wrap up painful and repetitive aspects
 * of the Java XML APIs.
 *
 * @author kgaughan
 */
public final class XmlUtils {
	...
	/**
	 * Creates a new instance of <code>org.w3c.dom.Document</code>.
	 *
	...
	public static Document newDocument() {
		...
		try {
			...
			// Shouldn't, in any sane world, happen, but...
	...
	public static void transform(final Source source, final Result result) {
		...
		try {
			...
			throw new XmlException("Could not do identity transform on XML document.", ex);
		}
	}

	/*
	 * The following code is taken from Apache Software Foundation's Xerces
	 * XML parser, specifically the file XMLChar.java. There's no guarantee
	 * that Xerces will be there for me to use, so I copied it here, and
	 * made a couple of stylistic tweaks.
	 */
